 ...
 */
class OimoUtil {
	public static function addRagdollJoint(w:World, rb1:RigidBody, rb2:RigidBody, anchor:Vec3, twistAxis:Vec3, swingAxis:Vec3, swingSd:SpringDamper = null,
			maxSwing1Deg:Float = 180, maxSwing2Deg:Float = 180, twistSd:SpringDamper = null, twistLm:RotationalLimitMotor = null):RagdollJoint {
