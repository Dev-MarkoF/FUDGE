 ...
 */
	export class BroadPhase {
		 ...
		 */
		createProxy(userData: any, aabb: Aabb): oimo.collision.broadphase.Proxy;
		/**
		 ...
		 */
		moveProxy(proxy: oimo.collision.broadphase.Proxy, aabb: Aabb, displacement: Vec3): void;
		/**
		 ...
		 */
		rayCast(begin: Vec3, end: Vec3, callback: oimo.collision.broadphase.BroadPhaseProxyCallback): void;
		/**
		 ...
		 * transform `begin`.
		 */
		convexCast(convex: ConvexGeometry, begin: Transform, translation: Vec3, callback: oimo.collision.broadphase.BroadPhaseProxyCallback): void;
		/**
		 * Performs an AABB query. `callback.process` is called for all proxies that their AABB
		 * and `aabb` intersect.
		 */
		aabbTest(aabb: Aabb, callback: oimo.collision.broadphase.BroadPhaseProxyCallback): void;
	}
	...
	export class BruteForceBroadPhase extends oimo.collision.broadphase.BroadPhase {
		...
		createProxy(userData: any, aabb: Aabb): oimo.collision.broadphase.Proxy;
		destroyProxy(proxy: oimo.collision.broadphase.Proxy): void;
		moveProxy(proxy: oimo.collision.broadphase.Proxy, aabb: Aabb, dislacement: Vec3): void;
		collectPairs(): void;
		rayCast(begin: Vec3, end: Vec3, callback: oimo.collision.broadphase.BroadPhaseProxyCallback): void;
		convexCast(convex: ConvexGeometry, begin: Transform, translation: Vec3, callback: oimo.collision.broadphase.BroadPhaseProxyCallback): void;
		aabbTest(aabb: Aabb, callback: oimo.collision.broadphase.BroadPhaseProxyCallback): void;
	...
	*/
	...
	export class BoxGeometry extends ConvexGeometry {
		...
		_updateMass(): void;
		_computeAabb(aabb: Aabb, tf: Transform): void;
		computeLocalSupportingVertex(dir: oVec3, out: Vec3): void;
		_rayCastLocal(beginX: number, beginY: number, beginZ: number, endX: number, endY: number, endZ: number, hit: RayCastHit): boolean;
	}
 ...
 */
	...
	export class Detector {
		 ...
		 */
		detect(result: oimo.collision.narrowphase.DetectorResult, geom1: Geometry, geom2: Geometry, transform1: Transform, transform2: Transform, cachedData: oimo.collision.narrowphase.detector.CachedDetectorData): void;
	}
 ...
 */
	export class EpaTriangle {
		...
		id: number;
		init(vertex1: oimo.collision.narrowphase.detector.gjkepa.EpaVertex, vertex2: oimo.collision.narrowphase.detector.gjkepa.EpaVertex, vertex3: oimo.collision.narrowphase.detector.gjkepa.EpaVertex, center: Vec3, autoCheck?: boolean): boolean;
 ...
 */
	export class EpaVertex {
		...
		randId: number;
		init(v: Vec3, w1: Vec3, w2: Vec3): oimo.collision.narrowphase.detector.gjkepa.EpaVertex;
		removeReferences(): void;
	}
 ...
 */
	...
	export class GjkEpa {
		 ...
		 */
		computeClosestPoints(c1: ConvexGeometry, c2: ConvexGeometry, tf1: Transform, tf2: Transform, cache: oimo.collision.narrowphase.detector.CachedDetectorData): number;
		/**
		 ...
		 * Set the compiler option `OIMO_GJK_EPA_DEBUG` for debugging (warning: massive logging).
		 */
		computeDistance(c1: ConvexGeometry, c2: ConvexGeometry, tf1: Transform, tf2: Transform, cache: oimo.collision.narrowphase.detector.CachedDetectorData): number;
		/**
 ...
 */
	export class RayCastCallback {
		 ...
		 */
		process(shape: oimo.dynamics.rigidbody.Shape, hit: RayCastHit): void;
	}
 ...
 */
	export class World {
		 ...
		 */
		rayCast(begin: Vec3, end: Vec3, callback: oimo.dynamics.callback.RayCastCallback): void;
		/**
		 * Performs a convex casting. `callback.process` is called for all shapes the convex geometry
		 * `convex` hits. The convex geometry translates by `translation` starting from the beginning
		 * transform `begin`.
		 */
		convexCast(convex: ConvexGeometry, begin: Transform, translation: Vec3, callback: oimo.dynamics.callback.RayCastCallback): void;
		/**
		 * Performs an AABB query. `callback.process` is called for all shapes that their
		 * AABB and `aabb` intersect.
		 */
		aabbTest(aabb: Aabb, callback: oimo.dynamics.callback.AabbTestCallback): void;
		/**
 ...
 */
	export class ManifoldUpdater {
		...
		totalUpdate(result: oimo.collision.narrowphase.DetectorResult, tf1: Transform, tf2: Transform): void;
		incrementalUpdate(result: oimo.collision.narrowphase.DetectorResult, tf1: Transform, tf2: Transform): void;
	}
 ...
 */
	export class CylindricalJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3, worldAxis: Vec3): oimo.dynamics.constraint.joint.CylindricalJointConfig;
	}
 ...
 */
	...
	export class GenericJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3, worldBasis1: Mat3, worldBasis2: Mat3): oimo.dynamics.constraint.joint.GenericJointConfig;
	}
 ...
 */
	...
	export class PrismaticJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 * from the world axis `worldAxis`, and returns `this`.
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3, worldAxis: Vec3): oimo.dynamics.constraint.joint.PrismaticJointConfig;
	}
 ...
 */
	export class RagdollJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3, worldTwistAxis: Vec3, worldSwingAxis: Vec3): oimo.dynamics.constraint.joint.RagdollJointConfig;
	}
	...
	export class RevoluteJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 * from the world axis `worldAxis`, and returns `this`.
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3, worldAxis: Vec3): oimo.dynamics.constraint.joint.RevoluteJointConfig;
	}
	...
	export class SphericalJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3): oimo.dynamics.constraint.joint.SphericalJointConfig;
	}
	...
	export class UniversalJointConfig extends oimo.dynamics.constraint.joint.JointConfig {
		 ...
		 */
		init(rigidBody1: oimo.dynamics.rigidbody.RigidBody, rigidBody2: oimo.dynamics.rigidbody.RigidBody, worldAnchor: Vec3, worldAxis1: Vec3, worldAxis2: Vec3): oimo.dynamics.constraint.joint.UniversalJointConfig;
	}
